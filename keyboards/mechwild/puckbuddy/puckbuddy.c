...
static void render_name(void) {     // Render Puckbuddy "Get Puck'd" text
    static const char PROGMEM name[] = {
        ...
        0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xB6, 0xB6, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE, 0xCF, 0xD0, 0xD1, 0xD2, 0x00
    };
    oled_set_cursor(0,0);
...
static void render_logo(void) {     // Render MechWild "MW" Logo
    static const char PROGMEM logo[] = {
        0x97, 0x98, 0x99, 0x9A, '\r',
        0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, '\r',
        0xD7, 0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xB6, '\r',
        0xB6, 0xB6, 0xB6, 0x9B, 0x9C, 0x9D, 0x9E, 0x00
    };
    oled_set_cursor(0,0);
